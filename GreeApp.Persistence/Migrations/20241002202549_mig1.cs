        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_ItemProducts_ItemProductId",
                        column: x => x.ItemProductId,
                        principalTable: "ItemProducts",
                        principalColumn: "ItemProductId");
                });

            migrationBuilder.CreateTable(
                name: "ItemProductProduct",
                columns: table => new
                {
                    ProductItemsItemProductId = table.Column<int>(type: "int", nullable: false),
                    ProductsProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemProductProduct", x => new { x.ProductItemsItemProductId, x.ProductsProductId });
                    table.ForeignKey(
                        name: "FK_ItemProductProduct_ItemProducts_ProductItemsItemProductId",
                        column: x => x.ProductItemsItemProductId,
                        principalTable: "ItemProducts",
                        principalColumn: "ItemProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemProductProduct_Products_ProductsProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsFeatures", x => x.ProductFeatureId);
                    table.ForeignKey(
                        name: "FK_ProductsFeatures_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "FeatureId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsFeatures_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemProductProduct_ProductsProductId",
                table: "ItemProductProduct",
                column: "ProductsProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_ItemProductId",
                table: "Items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsFeatures_FeatureId",
                table: "ProductsFeatures",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsFeatures_ProductId",
                table: "ProductsFeatures",
                column: "ProductId");
        }
